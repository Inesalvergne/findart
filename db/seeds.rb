...
creation_date: 'May 1st', category: 'Sculpture', price_rate:  5_000_000, style: 'Renaissance', user: User.rand,
...
style: 'Renaissance', user: User.rand, image_url: "https://en.wikipedia.
...
ArtPiece.create(title: "The Scream", artist: "Edvard Munch", description: "The Scream is the popular
  ...
  creation_date: 	1893, category: 'Proto-Expressionism', price_rate: 1_900_000, style:'Expressionist', user: User.rand,
...
ArtPiece.create(title: "Portrait de l'artiste sans barbe", artist: 'Vincent van Gogh', description:"Van Gogh's dozens
  ...
  creation_date: 1889, category: "Painting", price_rate: 1_800_000, style:"Impressionist", user: User.rand,
...
ArtPiece.create(title: 'Portrait of Dr. Gachet', artist: 'Vincent van Gogh', description:"Portrait of
  ...
  ArtPiece.create(title: "L'Homme au doigt (Pointing Man)", artist: "Alberto Giacometti", description:"Passionate about sculpture
   ...
   creation_date: 1947, category: "Sculpture", price_rate: 950_000, style: "Surreal", user: User.rand,
...
ArtPiece.create(title: "Balloon Dogs" , artist: "Jeff Koons", description:"Jeff Koons is renowned
  for making grand replicas of banal, everyday objects. With a price tag of
  ...
  creation_date: 1994, category: "Sculpture", price_rate: 900_000, style: "Conceptual Art", user: User.rand,
