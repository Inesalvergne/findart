...
and representing the of the heavens.', category: 'Painting', price_rate: '$2,500,000',
 style: 'Renaissance', user: User.rand, image_url: ""https://en.wikipedia.org/wiki/Salvator_Mundi_(Leonardo)#/media/File:Leonardo_da_Vinci,_Salvator_Mundi,_c.1500,_oil_on_walnut,_45.4_%C3%97_65.6_cm.jpg")" )
...
ArtPiece.create(title: 'Portrait of Dr. Gachet', artist: 'Vincent van Gogh', description:"Portrait of
  ...
  creation_date: 1890 category: "Painting", price_rate: 1_000_000, style: "Post-Impressionism", user: User.rand)
